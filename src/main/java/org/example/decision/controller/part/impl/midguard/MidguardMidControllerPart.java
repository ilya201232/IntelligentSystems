...
public class MidguardMidControllerPart extends ControllerPart {
    ...
    public MidguardMidControllerPart(boolean isTop) {
        this.isTop = isTop;
    }
    ...
    public Optional<Action> decideAction(Perception perception, Knowledge knowledge, Map<ControllerDataType, ControllerData> data) {
        ...
        if (
            (ballPosition.getX() > (-X_WALL_ABS - DELTA) && ballPosition.getX() < (X_WALL_ABS + DELTA)) && (
