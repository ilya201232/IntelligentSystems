...
public class AttackMidControllerPart extends ControllerPart {
    ...
    public AttackMidControllerPart(boolean isTop) {
        this.isTop = isTop;
    }
    ...
    public Optional<Action> decideAction(Perception perception, Knowledge knowledge, Map<ControllerDataType, ControllerData> data) {
        ...
        // TODO: Ball is always visible here since it must be visible to pass High and Highest Controller
